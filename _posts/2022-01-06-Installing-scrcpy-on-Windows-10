...
<h4>This year I am focusing more my studies than ever before. I've been learning with TCM Security and I start college for Computer Science!</h4>
<h4>I think this year is gonna be pretty excited.</h4>
...
<p>Armed with this little guide, I set off with the first step of setting-up ADB. I'd run <code>./adb.exe devices</code> and......... nothing shows under the list.</p>
<img src="https://kayleesg.github.io/kayleesgblog/no-devices-here.png">

<h2>Troubleshooting to the rescue</h2>
<p>The first thing I do is check to double check:</p>
<ul>
<li>That my phone is plugged in .......... Check</li>
<li>That developer mode is turned on ..... Check</li>
<li>That USB Debugging is turned on ...... And check</li>
</ul>
<p>With those checks out of the way, I realize that I never got the prompt to do file transfers. Normally, when you plug an Android phone into a computer, the phone and the computer start to talk. I realized that I never got the prompt and my phone isn't recognizing my computer.</p>
...
<p>Bottom line, the solution was to PTP mode over MTP. PTP is just used with pictures while MTP transfers all media. It didn't hurt to try so try I did ... and it worked.</p>
...
<h3>Layer 1 troubleshooting holds the answer to 99% of problems</h3>
<h3>The internet is vast and someone has tried to do the same thing as you</h3>
<h3>Never give up, and definitiely never panic if something isn't going the way you want it to</h3>
